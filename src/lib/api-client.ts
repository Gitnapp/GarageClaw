...
const GATEWAY_WS_DIAG_FLAG = 'garageclaw:gateway-ws-diagnostic';
...
function shouldLogApiRequests(): boolean {
  try {
    return import.meta.env.DEV || window.localStorage.getItem('garageclaw:api-log') === '1';
  } catch {

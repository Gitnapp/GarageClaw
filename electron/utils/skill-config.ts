...
interface PreinstalledMarker {
    source: 'garageclaw-preinstalled';
    slug: string;
    version: string;
    installedAt: string;
}
...
/**
 * Built-in skills bundled with GarageClaw that should be pre-deployed to
...
const PREINSTALLED_MARKER_NAME = '.garageclaw-preinstalled.json';

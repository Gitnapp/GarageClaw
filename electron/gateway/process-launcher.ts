...
(function () {
  ...
  if (globalThis.__garageclawFetchPatched) return;
  globalThis.__garageclawFetchPatched = true;

  globalThis.fetch = function garageclawFetch(input, init) {
    var url =
  ...
  if (process.platform === 'win32') {
    try {
      ...
      if (!cp.__garageclawPatched) {
        cp.__garageclawPatched = true;
